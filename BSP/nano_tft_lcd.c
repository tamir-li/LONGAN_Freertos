#include "nano_tft_lcd.h"
#include "lcd_font.h"


static u16 BACK_COLOR;   //Background color
void set_Background_color(u16 backcolor)
{
...
void LCD_Writ_Bus(u8 dat)
{
	...
	OLED_CS_Set();
#elif SPI0_CFG == HARDWARE_DMA_SPI
...
/******************************************************************************
       ...
       Return value: None
******************************************************************************/
void LCD_Clear_Char(u16 x,u16 y,u16 Color)
{
	u16 i,j;
	LCD_Address_Set(x,y,x+8-1,y+16-1);      //Set cursor position    for(i=0;i<LCD_W;i++)
    for(i=0;i<16;i++)
	  {
			for (j=0;j<8;j++)
				{
...
void LCD_ShowChar(u16 x,u16 y,u8 num,u8 mode,u16 color)
{
	...
	if(!mode) //Non-overlapping
	{
		...
		{
			temp=ascii_16x08[(u16)num*16+pos];		 //Call 1608 font
			for(t=0;t<8;t++)
		    {
...
/******************************************************************************
       ...
       Return value: None
******************************************************************************/
void LCD_ShowNum_int(u16 x,u16 y,u16 num,u8 len,u16 color)
{
	u8 t,temp;
	u8 enshow=0;
	for(t=0;t<len;t++)
...
/******************************************************************************
       ...
       Return value: None
******************************************************************************/
void LCD_ShowNum_float(u16 x,u16 y,float num,u8 len,u16 color)
{
	u8 t,temp;
	// u8 enshow=0;
	u16 num1;
